...
/**
 * Costruisce l'URL della foto per la hero image.
 * Priorità: photo_url in DB → proxy place_id → proxy text search per nome
 */
...
export default async function VenuePage({ params }: Props) {
  ...
  // Foto: da DB se già salvata, altrimenti proxy Google Places
